 ...
 * <ul>
 *   <li>{@link info.kwarc.elf.impl.signatureDeclarationImpl#getSigName <em>Sig Name</em>}</li>
 *   <li>{@link info.kwarc.elf.impl.signatureDeclarationImpl#getSigDefinitions <em>Sig Definitions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class signatureDeclarationImpl extends TempTypeImpl implements signatureDeclaration
{
  ...
  {
    return ElfPackage.Literals.SIGNATURE_DECLARATION;
  }
  ...
  public void setSigName(String newSigName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ElfPackage.SIGNATURE_DECLARATION__SIG_NAME, oldSigName, sigName));
  }
  ...
  public EList<sigDefinitions> getSigDefinitions()
  {
    ...
    {
      sigDefinitions = new EObjectContainmentEList<sigDefinitions>(sigDefinitions.class, this, ElfPackage.SIGNATURE_DECLARATION__SIG_DEFINITIONS);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ElfPackage.SIGNATURE_DECLARATION__SIG_DEFINITIONS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ElfPackage.SIGNATURE_DECLARATION__SIG_NAME:
        return getSigName();
      case ElfPackage.SIGNATURE_DECLARATION__SIG_DEFINITIONS:
