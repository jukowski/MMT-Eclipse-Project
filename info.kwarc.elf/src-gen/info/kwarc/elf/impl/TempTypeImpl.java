 ...
 * <ul>
 *   <li>{@link info.kwarc.elf.impl.TempTypeImpl#getFullURI <em>Full URI</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TempTypeImpl extends MinimalEObjectImpl.Container implements TempType
{
  ...
  {
    return ElfPackage.Literals.TEMP_TYPE;
  }
  ...
  public void setFullURI(String newFullURI)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ElfPackage.TEMP_TYPE__FULL_URI, oldFullURI, fullURI));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ElfPackage.TEMP_TYPE__FULL_URI:
        return getFullURI();
    }
