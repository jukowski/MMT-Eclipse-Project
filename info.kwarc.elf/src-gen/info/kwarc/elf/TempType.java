 ...
 * <ul>
 *   <li>{@link info.kwarc.elf.TempType#getFullURI <em>Full URI</em>}</li>
 * </ul>
 * </p>
 *
 * @see info.kwarc.elf.ElfPackage#getTempType()
 * @model
 * @generated
 */
public interface TempType extends EObject
{
   ...
   * @see info.kwarc.elf.ElfPackage#getTempType_FullURI()
   * @model
   * @generated
   */
  String getFullURI();
  ...
  /**
   * Sets the value of the '{@link info.kwarc.elf.TempType#getFullURI <em>Full URI</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
