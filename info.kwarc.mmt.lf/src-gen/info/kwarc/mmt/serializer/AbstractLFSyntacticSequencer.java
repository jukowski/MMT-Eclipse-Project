...
public class AbstractLFSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_sigDefinitions_SOMETHINGParserRuleCall_3_4_a;
	protected AbstractElementAlias match_sigDefinitions_SOMETHINGParserRuleCall_4_1_a;
	...
	protected AbstractElementAlias match_sigDefinitions_WSParserRuleCall_3_2_p;
	protected AbstractElementAlias match_sigDefinitions___InfixKeyword_3_0_0_or_PrefixKeyword_3_0_1___WSParserRuleCall_3_1_0_p;
	protected AbstractElementAlias match_sigDefinitions___InfixKeyword_3_0_0_or_PrefixKeyword_3_0_1___WSParserRuleCall_3_2_p;
	protected AbstractElementAlias match_sigDefinitions___WSParserRuleCall_1_3_0_p_IncludeOpsParserRuleCall_1_3_1__q;
	protected AbstractElementAlias match_signatureDeclaration_WSParserRuleCall_10_a;
	protected AbstractElementAlias match_signatureDeclaration_WSParserRuleCall_1_p;
	protected AbstractElementAlias match_signatureDeclaration_WSParserRuleCall_3_a_EqualsSignKeyword_4_WSParserRuleCall_5_a_LeftCurlyBracketKeyword_6_WSParserRuleCall_7_a_RightCurlyBracketKeyword_9_WSParserRuleCall_10_a;
	protected AbstractElementAlias match_signatureDeclaration_WSParserRuleCall_3_a_EqualsSignKeyword_4_WSParserRuleCall_5_a_LeftCurlyBracketKeyword_6_WSParserRuleCall_7_p;
	protected AbstractElementAlias match_viewDeclaration_WSParserRuleCall_11_a_EqualsSignKeyword_12_WSParserRuleCall_13_a_LeftCurlyBracketKeyword_14_WSParserRuleCall_15_a_RightCurlyBracketKeyword_17_WSParserRuleCall_18_a;
	protected AbstractElementAlias match_viewDeclaration_WSParserRuleCall_11_a_EqualsSignKeyword_12_WSParserRuleCall_13_a_LeftCurlyBracketKeyword_14_WSParserRuleCall_15_p;
	protected AbstractElementAlias match_viewDeclaration_WSParserRuleCall_18_a;
	...
	protected void init(IGrammarAccess access) {
		...
		match_sigDefinitions_SOMETHINGParserRuleCall_3_4_a = new TokenAlias(true, true, grammarAccess.getSigDefinitionsAccess().getSOMETHINGParserRuleCall_3_4());
		match_sigDefinitions_SOMETHINGParserRuleCall_4_1_a = new TokenAlias(true, true, grammarAccess.getSigDefinitionsAccess().getSOMETHINGParserRuleCall_4_1());
		...
		match_sigDefinitions_WSParserRuleCall_3_2_p = new TokenAlias(false, true, grammarAccess.getSigDefinitionsAccess().getWSParserRuleCall_3_2());
		match_sigDefinitions___InfixKeyword_3_0_0_or_PrefixKeyword_3_0_1___WSParserRuleCall_3_1_0_p = new GroupAlias(false, false, new AlternativeAlias(false, false, new TokenAlias(false, false, grammarAccess.getSigDefinitionsAccess().getInfixKeyword_3_0_0()), new TokenAlias(false, false, grammarAccess.getSigDefinitionsAccess().getPrefixKeyword_3_0_1())), new TokenAlias(false, true, grammarAccess.getSigDefinitionsAccess().getWSParserRuleCall_3_1_0()));
		match_sigDefinitions___InfixKeyword_3_0_0_or_PrefixKeyword_3_0_1___WSParserRuleCall_3_2_p = new GroupAlias(false, false, new AlternativeAlias(false, false, new TokenAlias(false, false, grammarAccess.getSigDefinitionsAccess().getInfixKeyword_3_0_0()), new TokenAlias(false, false, grammarAccess.getSigDefinitionsAccess().getPrefixKeyword_3_0_1())), new TokenAlias(false, true, grammarAccess.getSigDefinitionsAccess().getWSParserRuleCall_3_2()));
		...
		match_signatureDeclaration_WSParserRuleCall_10_a = new TokenAlias(true, true, grammarAccess.getSignatureDeclarationAccess().getWSParserRuleCall_10());
		...
		match_signatureDeclaration_WSParserRuleCall_3_a_EqualsSignKeyword_4_WSParserRuleCall_5_a_LeftCurlyBracketKeyword_6_WSParserRuleCall_7_a_RightCurlyBracketKeyword_9_WSParserRuleCall_10_a = new GroupAlias(false, false, new TokenAlias(true, true, grammarAccess.getSignatureDeclarationAccess().getWSParserRuleCall_3()), new TokenAlias(false, false, grammarAccess.getSignatureDeclarationAccess().getEqualsSignKeyword_4()), new TokenAlias(true, true, grammarAccess.getSignatureDeclarationAccess().getWSParserRuleCall_5()), new TokenAlias(false, false, grammarAccess.getSignatureDeclarationAccess().getLeftCurlyBracketKeyword_6()), new TokenAlias(true, true, grammarAccess.getSignatureDeclarationAccess().getWSParserRuleCall_7()), new TokenAlias(false, false, grammarAccess.getSignatureDeclarationAccess().getRightCurlyBracketKeyword_9()), new TokenAlias(true, true, grammarAccess.getSignatureDeclarationAccess().getWSParserRuleCall_10()));
		match_signatureDeclaration_WSParserRuleCall_3_a_EqualsSignKeyword_4_WSParserRuleCall_5_a_LeftCurlyBracketKeyword_6_WSParserRuleCall_7_p = new GroupAlias(false, false, new TokenAlias(true, true, grammarAccess.getSignatureDeclarationAccess().getWSParserRuleCall_3()), new TokenAlias(false, false, grammarAccess.getSignatureDeclarationAccess().getEqualsSignKeyword_4()), new TokenAlias(true, true, grammarAccess.getSignatureDeclarationAccess().getWSParserRuleCall_5()), new TokenAlias(false, false, grammarAccess.getSignatureDeclarationAccess().getLeftCurlyBracketKeyword_6()), new TokenAlias(false, true, grammarAccess.getSignatureDeclarationAccess().getWSParserRuleCall_7()));
		match_viewDeclaration_WSParserRuleCall_11_a_EqualsSignKeyword_12_WSParserRuleCall_13_a_LeftCurlyBracketKeyword_14_WSParserRuleCall_15_a_RightCurlyBracketKeyword_17_WSParserRuleCall_18_a = new GroupAlias(false, false, new TokenAlias(true, true, grammarAccess.getViewDeclarationAccess().getWSParserRuleCall_11()), new TokenAlias(false, false, grammarAccess.getViewDeclarationAccess().getEqualsSignKeyword_12()), new TokenAlias(true, true, grammarAccess.getViewDeclarationAccess().getWSParserRuleCall_13()), new TokenAlias(false, false, grammarAccess.getViewDeclarationAccess().getLeftCurlyBracketKeyword_14()), new TokenAlias(true, true, grammarAccess.getViewDeclarationAccess().getWSParserRuleCall_15()), new TokenAlias(false, false, grammarAccess.getViewDeclarationAccess().getRightCurlyBracketKeyword_17()), new TokenAlias(true, true, grammarAccess.getViewDeclarationAccess().getWSParserRuleCall_18()));
		match_viewDeclaration_WSParserRuleCall_11_a_EqualsSignKeyword_12_WSParserRuleCall_13_a_LeftCurlyBracketKeyword_14_WSParserRuleCall_15_p = new GroupAlias(false, false, new TokenAlias(true, true, grammarAccess.getViewDeclarationAccess().getWSParserRuleCall_11()), new TokenAlias(false, false, grammarAccess.getViewDeclarationAccess().getEqualsSignKeyword_12()), new TokenAlias(true, true, grammarAccess.getViewDeclarationAccess().getWSParserRuleCall_13()), new TokenAlias(false, false, grammarAccess.getViewDeclarationAccess().getLeftCurlyBracketKeyword_14()), new TokenAlias(false, true, grammarAccess.getViewDeclarationAccess().getWSParserRuleCall_15()));
		match_viewDeclaration_WSParserRuleCall_18_a = new TokenAlias(true, true, grammarAccess.getViewDeclarationAccess().getWSParserRuleCall_18());
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		else if(match_sigDefinitions_SOMETHINGParserRuleCall_3_4_a.equals(transition.getAmbiguousSyntax()))
			emit_sigDefinitions_SOMETHINGParserRuleCall_3_4_a(semanticObject, transition, fromNode, toNode);
		else if(match_sigDefinitions_SOMETHINGParserRuleCall_4_1_a.equals(transition.getAmbiguousSyntax()))
			emit_sigDefinitions_SOMETHINGParserRuleCall_4_1_a(semanticObject, transition, fromNode, toNode);
		...
		else if(match_sigDefinitions_WSParserRuleCall_3_2_p.equals(transition.getAmbiguousSyntax()))
			emit_sigDefinitions_WSParserRuleCall_3_2_p(semanticObject, transition, fromNode, toNode);
		else if(match_sigDefinitions___InfixKeyword_3_0_0_or_PrefixKeyword_3_0_1___WSParserRuleCall_3_1_0_p.equals(transition.getAmbiguousSyntax()))
			emit_sigDefinitions___InfixKeyword_3_0_0_or_PrefixKeyword_3_0_1___WSParserRuleCall_3_1_0_p(semanticObject, transition, fromNode, toNode);
		else if(match_sigDefinitions___InfixKeyword_3_0_0_or_PrefixKeyword_3_0_1___WSParserRuleCall_3_2_p.equals(transition.getAmbiguousSyntax()))
			emit_sigDefinitions___InfixKeyword_3_0_0_or_PrefixKeyword_3_0_1___WSParserRuleCall_3_2_p(semanticObject, transition, fromNode, toNode);
		...
		else if(match_signatureDeclaration_WSParserRuleCall_10_a.equals(transition.getAmbiguousSyntax()))
			emit_signatureDeclaration_WSParserRuleCall_10_a(semanticObject, transition, fromNode, toNode);
		...
		else if(match_signatureDeclaration_WSParserRuleCall_3_a_EqualsSignKeyword_4_WSParserRuleCall_5_a_LeftCurlyBracketKeyword_6_WSParserRuleCall_7_a_RightCurlyBracketKeyword_9_WSParserRuleCall_10_a.equals(transition.getAmbiguousSyntax()))
			emit_signatureDeclaration_WSParserRuleCall_3_a_EqualsSignKeyword_4_WSParserRuleCall_5_a_LeftCurlyBracketKeyword_6_WSParserRuleCall_7_a_RightCurlyBracketKeyword_9_WSParserRuleCall_10_a(semanticObject, transition, fromNode, toNode);
		else if(match_signatureDeclaration_WSParserRuleCall_3_a_EqualsSignKeyword_4_WSParserRuleCall_5_a_LeftCurlyBracketKeyword_6_WSParserRuleCall_7_p.equals(transition.getAmbiguousSyntax()))
			emit_signatureDeclaration_WSParserRuleCall_3_a_EqualsSignKeyword_4_WSParserRuleCall_5_a_LeftCurlyBracketKeyword_6_WSParserRuleCall_7_p(semanticObject, transition, fromNode, toNode);
		else if(match_viewDeclaration_WSParserRuleCall_11_a_EqualsSignKeyword_12_WSParserRuleCall_13_a_LeftCurlyBracketKeyword_14_WSParserRuleCall_15_a_RightCurlyBracketKeyword_17_WSParserRuleCall_18_a.equals(transition.getAmbiguousSyntax()))
			emit_viewDeclaration_WSParserRuleCall_11_a_EqualsSignKeyword_12_WSParserRuleCall_13_a_LeftCurlyBracketKeyword_14_WSParserRuleCall_15_a_RightCurlyBracketKeyword_17_WSParserRuleCall_18_a(semanticObject, transition, fromNode, toNode);
		else if(match_viewDeclaration_WSParserRuleCall_11_a_EqualsSignKeyword_12_WSParserRuleCall_13_a_LeftCurlyBracketKeyword_14_WSParserRuleCall_15_p.equals(transition.getAmbiguousSyntax()))
			emit_viewDeclaration_WSParserRuleCall_11_a_EqualsSignKeyword_12_WSParserRuleCall_13_a_LeftCurlyBracketKeyword_14_WSParserRuleCall_15_p(semanticObject, transition, fromNode, toNode);
		else if(match_viewDeclaration_WSParserRuleCall_18_a.equals(transition.getAmbiguousSyntax()))
			emit_viewDeclaration_WSParserRuleCall_18_a(semanticObject, transition, fromNode, toNode);
	 ...
	 *     SOMETHING*
	 */
	protected void emit_sigDefinitions_SOMETHINGParserRuleCall_3_4_a(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		acceptNodes(transition, fromNode, toNode);
	}
	 ...
	 *     SOMETHING*
	 */
	protected void emit_sigDefinitions_SOMETHINGParserRuleCall_4_1_a(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		acceptNodes(transition, fromNode, toNode);
	}
	 ...
	 *     WS+
	 */
	protected void emit_sigDefinitions_WSParserRuleCall_3_2_p(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		acceptNodes(transition, fromNode, toNode);
	}
	 ...
	 *     ('%prefix' | '%infix') WS+
	 */
	protected void emit_sigDefinitions___InfixKeyword_3_0_0_or_PrefixKeyword_3_0_1___WSParserRuleCall_3_1_0_p(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		acceptNodes(transition, fromNode, toNode);
	}
	 ...
	 *     ('%prefix' | '%infix') WS+
	 */
	protected void emit_sigDefinitions___InfixKeyword_3_0_0_or_PrefixKeyword_3_0_1___WSParserRuleCall_3_2_p(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		acceptNodes(transition, fromNode, toNode);
	}
	 ...
	 *     WS*
	 */
	protected void emit_signatureDeclaration_WSParserRuleCall_10_a(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		acceptNodes(transition, fromNode, toNode);
	}
	 ...
	 */
	protected void emit_signatureDeclaration_WSParserRuleCall_3_a_EqualsSignKeyword_4_WSParserRuleCall_5_a_LeftCurlyBracketKeyword_6_WSParserRuleCall_7_a_RightCurlyBracketKeyword_9_WSParserRuleCall_10_a(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		acceptNodes(transition, fromNode, toNode);
	}
	 ...
	 *     WS* '=' WS* '{' WS+
	 */
	protected void emit_signatureDeclaration_WSParserRuleCall_3_a_EqualsSignKeyword_4_WSParserRuleCall_5_a_LeftCurlyBracketKeyword_6_WSParserRuleCall_7_p(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		acceptNodes(transition, fromNode, toNode);
	}
	 ...
	 */
	protected void emit_viewDeclaration_WSParserRuleCall_11_a_EqualsSignKeyword_12_WSParserRuleCall_13_a_LeftCurlyBracketKeyword_14_WSParserRuleCall_15_a_RightCurlyBracketKeyword_17_WSParserRuleCall_18_a(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		acceptNodes(transition, fromNode, toNode);
	}
	 ...
	 *     WS* '=' WS* '{' WS+
	 */
	protected void emit_viewDeclaration_WSParserRuleCall_11_a_EqualsSignKeyword_12_WSParserRuleCall_13_a_LeftCurlyBracketKeyword_14_WSParserRuleCall_15_p(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		acceptNodes(transition, fromNode, toNode);
	}
	 ...
	 *     WS*
	 */
	protected void emit_viewDeclaration_WSParserRuleCall_18_a(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		acceptNodes(transition, fromNode, toNode);
	}
