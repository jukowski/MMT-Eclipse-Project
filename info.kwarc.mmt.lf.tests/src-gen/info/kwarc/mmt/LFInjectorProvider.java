...
public class LFInjectorProvider implements IInjectorProvider, IRegistryConfigurator {
	...
	public Injector getInjector() {
		if (injector == null) {
			this.injector = new LFStandaloneSetup().createInjectorAndDoEMFRegistration();
		}
		return injector;
	}
